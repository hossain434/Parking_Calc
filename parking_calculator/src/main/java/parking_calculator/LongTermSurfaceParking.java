...
public class LongTermSurfaceParking {
	...
	public void beforeTest() throws IOException {
		...
		// csv file location
		String SAMPLE_CSV_FILE_PATH = path + "\\csvfile\\long_term_surface_parking.csv";
	...
	public void longTermSurfaceParking(String EntryDate, String EntryTime, String LeavingDate, String LeavingTime,
